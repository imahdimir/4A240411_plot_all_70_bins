...
def make_all_combinations() :
    ...
    ##
    gt = {
            0 : ('FS' , fp.dsg_i , fp.fs_dsg_corr) ,
            1 : ('FS' , fp.hc_i , fp.fs_hc_corr) ,
            2 : ('PO' , fp.dsg_i , fp.po_dsg_corr) ,
            3 : ('PO' , fp.hc_i , fp.po_hc_corr) ,
            }
...
def save_corr(pr , ip , op , iscore) :
    ...
    def _test() :
        ...
        pr = 'PO'
        iscore = .4
        ip = fp.dsg_i.as_posix().format(int(iscore * 100))
        print(ip)
